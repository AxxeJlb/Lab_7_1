...
int main() {
    ...
    Model ourModel("Lab_3_Tigrov.obj");

    objectTransforms.resize(4);

    // Настройка точки вращения для об. 2
    objectTransforms[2].pivotPoint = glm::vec3(0.93f, 0.34f, 0.0f);
